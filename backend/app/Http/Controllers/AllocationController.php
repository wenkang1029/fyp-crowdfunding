...
class AllocationController extends Controller
{
    ...
    public function generate(Request $request, \App\Services\GeminiService $geminiService)
    {
        if ($request->user()->role !== 'ngo') {
            return response()->json([
                'success' => false,
        ...
        $request->validate([
            'file' => 'required|file|mimes:pdf,jpg,jpeg,png|max:10240', // Limit to 10MB
        ]);
        ...
        try {
            ...
            $allocations = $geminiService->generateAllocationsFromDocument($base64Data, $mimeType);
            ...
            return response()->json([
                ...
                'message' => 'Allocations successfully generated by Gemini AI!'
            ], 200);
